//Objective: Write a JavaScript function to calculate the factorial of a number.

//Step 1: Write a function name factorial that takes in one parameter name (num) and the goal is to calculate the factorial of a number.
