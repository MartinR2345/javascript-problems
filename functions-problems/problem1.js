...
//Step 5: Create a if statment. Why? This will check to see if my newArray[i] is greater than my longest varable and if it is then longest will be updated to newArray[i]
